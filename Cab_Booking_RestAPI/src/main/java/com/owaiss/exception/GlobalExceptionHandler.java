...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> userExpHandler(DriverException ee, WebRequest req){
	...
	public ResponseEntity<MyErrorDetails> userExpHandler(CabException ue, WebRequest req){
